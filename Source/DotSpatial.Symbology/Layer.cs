...
namespace DotSpatial.Symbology
{
  ...
  public class Layer : RenderableLegendItem, ILayer
  {
    ...
    /// Moved a bunch of items under an "advanced" menu option
    /// </summary>
    private void Configure()
    {
      ...
      SymbologyMenuItem mnuAdvanced = new SymbologyMenuItem("Advanced");

      mnuAdvanced.MenuItems.Add(new SymbologyMenuItem(SymbologyMessageStrings.SetDynamicVisibilityScale, SymbologyImages.ZoomScale, SetDynamicVisibility));
      ...
      mnuAdvanced.MenuItems.Add(mnuData);

      ContextMenuItems.Add(mnuAdvanced);
      ContextMenuItems.Add(new SymbologyMenuItem("-"));
